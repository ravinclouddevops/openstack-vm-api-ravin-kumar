...
def _map_vol_status(raw: str | None) -> VolumeStatus:
    try:
...
def _map_snap_status(raw: str | None) -> SnapshotStatus:
    try:
...
class VolumeService:
    ...
    def delete_volume(self, volume_id: str) -> None:
        self._repo.get_volume(volume_id)  # validate existence
    ...
    def list_snapshots(self, volume_id: str | None = None) -> list[SnapshotResponse]:
